    ...
    <footer className="bg-gray-800 text-gray-300 mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">About GiftWise</h3>
            <p className="text-sm text-gray-300">GiftWise is your one-stop shop for finding the perfect gift for any occasion.</p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/gifts" className="text-sm text-gray-400 hover:text-white">Gifts</Link></li>
              <li><Link href="/cart" className="text-sm text-gray-400 hover:text-white">Cart</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 text-center">
          <p className="text-sm text-gray-400">&copy; 2023 GiftWise. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
